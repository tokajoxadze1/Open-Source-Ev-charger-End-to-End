...
# 🔌 Open-Source EV დამტენის სისტემა (End-to-End)

## 🚗 რა არის ეს პროექტი?

ეს გიჩვენებს როგორ ააწყო სრულფასოვანი ელექტრო მანქანის დამტენის სისტემა **open-source პროგრამებით**.

იდეა მარტივია:

* გამოიყენებ უკვე მზად ღია კოდის პროექტებს GitHub-დან
* დააკავშირებ ერთმანეთთან
* მიიღებ სრულ EV charging სისტემას (backend + frontend + charger simulation)

ამ მაგალითში გამოიყენება:

* **Everest (charger simulator / software-in-the-loop)**
* **Open E-Mobility (backend + dashboard)**
...
Everest არის დამტენის სიმულატორი.

* ინსტალაციის ინსტრუქცია:
  [https://everest.github.io/nightly/](https://everest.github.io/nightly/)
...
1. Backend სერვერი
   [https://github.com/sap-labs-france/ev-server](https://github.com/sap-labs-france/ev-server)

2. Frontend Dashboard
   [https://github.com/sap-labs-france/ev-dashboard](https://github.com/sap-labs-france/ev-dashboard)

---

## ⚙️ Open E-Mobility-ში რა უნდა გააკეთო?

* შედი სისტემაში
* დააჭირე **ONBOARD NEW STATION**
* შექმენი ახალი დამტენის რეგისტრაცია (token)
* მიიღებ JSON ტოკენს
...
ეს არის შენი დამტენის იდენტიფიკატორი სისტემაში.

---

## ⚙️ Everest-ის კონფიგურაცია

შედი Linux სისტემაში (მაგ: Ubuntu) და გახსენი ფაილი:
...
## 📄 ocpp.json რას აკეთებს?

ეს ფაილი არის დამტენის “ტვინი” — აქ წერია:
...
```json
"CentralSystemURI": "localhost:8001/OCPP16/.../Everest-AC-Charger"
```

ეს აკავშირებს Everest-ს Open E-Mobility backend-თან 🔗
...
ეს ნიშნავს:
👉 სისტემა გამოიყენებს შენს კონფიგურაციას
...
## 📊 რა მოხდება გაშვების შემდეგ?

* დამტენი გამოჩნდება dashboard-ზე
* Node-RED / monitoring UI დაიწყებს მუშაობას
* Open E-Mobility დაინახავს ახალ charger-ს

---

## 🔐 RFID სისტემა

თუ გინდა charging-ის დაწყება:

* უნდა დაამატო RFID ბარათები სისტემაში
* თუ არ დაამატებ → სისტემა დაბლოკავს სესიას ❌

---

## ⚡ როგორ იწყება დატენვა?

1. ჩასვამ RFID
2. სისტემა ამოწმებს ავტორიზაციას
3. თუ სწორია → იწყება charging session
4. Dashboard-ზე ჩანს:
...
✔ სრულ EV charging სისტემას
✔ backend + frontend
✔ დამტენის სიმულაციას
✔ რეალურ OCPP კომუნიკაციას
✔ RFID ავტორიზაციას

და ყველაფერი ეს არის **open-source** ⚡
